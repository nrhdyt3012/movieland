...
<body style="background-color:#111111">
    <nav class="nav">
        <div class="nav-logo">
            <img src="images/movieland2 rev.png" alt="Movieland Logo">
        </div>
        <div class="nav-menu" id="navMenu">
            <ul>
                <li><a href="ghome.php" class="link active">Home</a></li>
                <li><a href="gtrending.html" class="link ">Trending</a></li>
                <li><a href="gcommunity.html" class="link">Community</a></li>
            </ul>
        </div>
        <div class="nav-button">
            <a href="signup.php"><button class="btn" id="registerBtn">Masuk / Daftar</button></a>
         </div>
    </nav>
<div class="content">
