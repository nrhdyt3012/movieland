...
include "koneksi2.php"; // Sertakan file koneksi
...
if(isset($_POST["signin"])){ // Periksa apakah tombol sign in telah ditekan
    ...
    $query = $koneksi->query("SELECT * FROM tb_admin WHERE email='$email' AND password='$password'");
    ...
    if($result == 1){ // Jika ditemukan data yang cocok
        ...
        echo "<script>alert('Login gagal');window.location='adminlogin.php'</script>";   
    }
}
?>
