...
<body style="background-color:#111111">
    <div class="wrapper">
        <nav class="nav">
            <div class="nav-logo">
                <img src="images/movieland2 rev.png">
            </div>
        ...
        <img src="images/siksakuburr.jpg" alt="Siksa Kubur Movie Poster">
    ...
    <div class="movie" data-movie-id="iparadalahmaut">
        ...
        <!-- ... -->
        <form action="submit_review.php" method="POST" class="review-form">
        <img src="images/download (2).jpeg" alt="Ipar Adalah Maut Movie Poster">
    ...
    <div class="movie" data-movie-id="possesion">
        ...
        <!-- ... -->
        <form action="submit_review.php" method="POST" class="review-form">
        <img src="images/download (1).jpeg" alt="Possession: Kerasukan Movie Poster">
    ...
    <div class="movie" data-movie-id="vinasebelum7hari">
        ...
        <!-- ... -->
        <form action="submit_review.php" method="POST" class="review-form">
        <img src="images/download.jpeg" alt="Vina: Sebelum 7 Hari Movie Poster">
